...
function extractData(rows) {
    ...
    for (let i = 1; i < rows.length; i++) {
        ...
        if (dataRefPeriodo && dataRefPeriodo.getDate() <= CUTOFF_DAY) {
            ...
            p.lucroRealAte12 += (valorPago - valorPrevisto); // [NOVO] Lucro Real até dia 12
        }
...
function createEmptyPeriod() {
    return {
        ...
        previstoAte12: 0, 
        pagoAte12: 0,
        lucroRealAte12: 0, // [NOVO] Lucro Real até dia 12
        status: { 
            'ATIVO': 0, 
            'NÃO EMPRESTAR': 0, 
            'QUITADO': 0, 
...
function renderConsolidatedReport(container) {
    ...
    allStatesData.forEach(state => {
        Object.entries(state.monthly).forEach(([period, d]) => {
            ...
            allPeriods[period].lucroRealAte12 += d.lucroRealAte12;
    ...
    Object.values(allPeriods).forEach(d => {
        ...
        globalTotals.lucroRealAte12 += d.lucroRealAte12;
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th class="text-right">Lucro Real (Até 12)</th>
                ...
                <tbody>
                    ${filteredPeriods.map(p => {
                        ...
                        return `
                            <tr>
                                ...
                                <td class="text-right ${d.lucroRealAte12 > 0 ? 'text-success' : (d.lucroRealAte12 < 0 ? 'text-danger' : '')}">${formatCurrency(d.lucroRealAte12)}</td>
                    ...
                    <tr class="totals-row">
                        ...
                        <td class="text-right">${formatCurrency(filteredTotals.lucroRealAte12)}</td>
...
function renderStateReport(state, type, container) {
    ...
    filteredPeriods.forEach(p => {
        ...
        totals.lucroRealAte12 += d.lucroRealAte12;
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr class="totals-row">
                        ...
                        <td class="text-right">${formatCurrency(totals.lucroRealAte12)}</td>
